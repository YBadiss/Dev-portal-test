...
<Jumbotron>
  ...
  <H2>A starter developer portal with training exercises test</H2>
...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="developer-portal/index.md" icon={icon1test} header="Rock">
    ...
    <ThinTile to="developer-portal/index.md" icon={launchFastIcontest} header="Paper">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </ThinTile>

...
<Jumbotron>
  ...
  <H2>The best API documentation ever</H2>
...
<Box my={25}>
  <SectionHeader>
    Here are some links to the Reference Documents
  </SectionHeader>
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="openapi/vault/reference.page.yaml" icon={icon1test} header="Vault API">
        Just testing. Click here to access to the Vault API documentation, in this portal.
    </ThinTile>
    <ThinTile to="https://horrible-seahorse-97.redoc.ly/" icon={launchFastIcontest} header="Wallet Daemon">
        Click here to access the Wallet Daemon EXTERNAL reference doc. Just testing..
    </ThinTile>
